...
function LiveStatusPseudoData() {
   ...
   function Section () {
      ...
      function GenerateLiveData() {
         var title_set = ["路口燈態", "綠燈倒數", "路口狀態", "優先策略", "p1訊息", "p2訊息", "p3訊息", "p4訊息"];
         var section_unique = [];
         var content_set = ["綠燈", "6s", "定時時制", "標準", "11:11 接收", "未接收", "未接收", "未接收"];
         section_unique[0] = SetUniqueInfo(title_set, content_set);
         var content_set = ["綠燈", "6s", "優先號誌", "紅燈切斷", "11:11 接收", "未接收", "未接收", "未接收"];
         section_unique[1] = SetUniqueInfo(title_set, content_set);
         var content_set = ["綠燈", "6s", "優先號誌", "綠燈延長", "11:11 接收", "未接收", "未接收", "未接收"];
